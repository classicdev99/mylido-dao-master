...
./contracts/assignment (assignment contract)

./test/assignment (test for assignment contract)

./hardhat.config.js (add hardhat mainnet forking configuration to test with live Lido contract)

./accounts.json (add api keys)

Test

npx hardhat compile

npx hardhat test test/assignment/lido-custody.test.js

npx hardhat coverage --testfiles test/assignment/lido-custody.test.js


Node version 12 is required or you may get timeout error while testing
