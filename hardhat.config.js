...
const getNetConfig = (networkName, ethAccountName) => {
  ...
  const byNetName = {
    ...
    hardhat: {
      forking: {
        url: 'https://eth-mainnet.alchemyapi.io/v2/' + accounts.mainnet.apiKey,
        blockNumber: accounts.mainnet.blockNumber
        // url: 'https://eth-goerli.alchemyapi.io/v2/' + accounts.goerli.apiKey,
        // blockNumber: accounts.goerli.blockNumber
      }
    }
  }
